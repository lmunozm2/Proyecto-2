...
server = app.server
# Tengo que ponerle el path de mi base de datos
#env_path="C:\\Users\\angie\\OneDrive\\Desktop\\Octavo semestre\\Analitica computacional\\Taller9\\actd_clase21\\env\\app copy.env"
# load env 
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            dcc.Input(id='amount-credit-input', type='number', min=0, max=100000, step=1, value=0),
        ...
        html.Div([
            html.Div([
                ...
                dcc.Input(id='amount-paid-sept-input', type='number', min=0, max=100000, step=1, value=0),
            ], style={'width': '16.5%', 'display': 'inline-block', 'margin': 'auto'}),
            html.Div([
                html.Label('Monto pagado en Agosto'),
                dcc.Input(id='amount-paid-aug-input', type='number', min=0, max=100000, step=1, value=0),
            ], style={'width': '16.5%', 'display': 'inline-block', 'margin': 'auto'}),
            html.Div([
                html.Label('Monto pagado en Julio'),
                dcc.Input(id='amount-paid-jul-input', type='number', min=0, max=100000, step=1, value=0),
            ], style={'width': '16.5%', 'display': 'inline-block', 'margin': 'auto'}),
            html.Div([
                html.Label('Monto pagado en Junio'),
                dcc.Input(id='amount-paid-jun-input', type='number', min=0, max=100000, step=1, value=0),
            ], style={'width': '16.5%', 'display': 'inline-block', 'margin': 'auto'}),
            html.Div([
                html.Label('Monto pagado en Mayo'),
                dcc.Input(id='amount-paid-may-input', type='number', min=0, max=100000, step=1, value=0),
            ], style={'width': '16.5%', 'display': 'inline-block', 'margin': 'auto'}),
            html.Div([
                html.Label('Monto pagado en Abril'),
                dcc.Input(id='amount-paid-apr-input', type='number', min=0, max=100000, step=1, value=0),
            ], style={'width': '16.5%', 'display': 'inline-block', 'margin': 'auto'}),
        ]),
